...
<head>
<title>Организационные расходы</title>
...
<p class="title">
<img src="/html/pics/icons/project.gif" alt="organizational" />
...
<input type="input" name="costs.organizational.$i" value="{$data[$i]}" class="cell"/>
</span>
</p>
EOD;
} ?>
