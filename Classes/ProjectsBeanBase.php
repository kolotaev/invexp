...
class ProjectsBeanBase extends BeanBase {
    ...
    // so that we can access them in a manner of connection between models (smth. like this 'projects.settings.n')
    // and maybe getDependencyModel() method solves the problem
    // or to populate it just in constructor
    // !!! think!
    ...
    protected function getDependencyModel($model) {
        $registry = Registry::getInstance();
        $beanfactory = $registry['BeanFactory'];
        return $beanfactory->build($model);
    }
